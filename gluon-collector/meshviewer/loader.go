...
// LoadNodesFromFile reads a nodes.json generated by ffmap-backend and converts it
// to structures we can store in our Nodeinfostore. Mostly the Firsteen time is of
// interest for us. The rest of the information should be updated with the next
// announced update anyway.
